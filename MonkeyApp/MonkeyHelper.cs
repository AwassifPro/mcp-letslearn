...
/// <summary>
/// Provides helper methods for managing monkey data and features.
/// </summary>
public static class MonkeyHelper
{
    ...
    private static readonly List<Monkey> monkeys = new()
    {
        ...
        new Monkey { Name = "Capuchin Monkey", Location = "Central & South America", Population = 23000, Details = "The capuchin monkeys are New World monkeys of the subfamily Cebinae.", Image = "https://raw.githubusercontent.com/jamesmontemagno/app-monkeys/master/capuchin.jpg", Latitude = 12.769013, Longitude = -85.602364 },
    ...
    /// </summary>
    public static Dictionary<string, int> MonkeyAccessCounts { get; } = monkeys.ToDictionary(m => m.Name, m => 0);

    /// <summary>
    /// Picks a random monkey from the list and increments the access counter.
    /// </summary>
    /// <returns>A randomly selected Monkey object.</returns>
    public static Monkey GetRandomMonkey()
    {
        var random = new Random();
        var selectedMonkey = monkeys[random.Next(monkeys.Count)];
        MonkeyAccessCounts[selectedMonkey.Name]++;
    ...
    /// Gets all monkeys.
    /// </summary>
    /// <returns>List of all Monkey objects.</returns>
